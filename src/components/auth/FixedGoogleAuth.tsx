...
interface FixedGoogleAuthProps {
  onSuccess?: () => void;
...
export function FixedGoogleAuth({
  onSuccess,
  onError,
  className = '',
  lang = 'ar',
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      console.log('🔄 Starting Fixed Google Sign-In...');
      ...
      console.error('❌ Fixed Google Sign-In error:', error);
